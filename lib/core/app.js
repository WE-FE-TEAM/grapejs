...
class App extends Base{
    ...
    execController(){
        ...
        //TODO 应该返回一个 404 错误
        return Promise.reject( new Error(`[${controllerKey}][${method}]不存在!!`) );
    }
    ...
    static run(){
        ...
        let swigConf = grape.configManager.getConfig('swig');

        grape.viewManager.setViewEngine(app);

        let staticPrefix = grape.path.APP_URL_PREFIX + '/static';
